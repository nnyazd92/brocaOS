...
class MemoryRecord(BaseModel):
    ...
    def xǁMemoryRecordǁupdate_last_used__mutmut_orig(self) -> None:
        """Update the last_used_at timestamp to now."""
        self.last_used_at = datetime.now(timezone.utc)
    
    def xǁMemoryRecordǁupdate_last_used__mutmut_1(self) -> None:
        """Update the last_used_at timestamp to now."""
        self.last_used_at = None
    
    def xǁMemoryRecordǁupdate_last_used__mutmut_2(self) -> None:
        """Update the last_used_at timestamp to now."""
        self.last_used_at = datetime.now(None)
    
    xǁMemoryRecordǁupdate_last_used__mutmut_mutants : ClassVar[MutantDict] = {
    'xǁMemoryRecordǁupdate_last_used__mutmut_1': xǁMemoryRecordǁupdate_last_used__mutmut_1, 
        'xǁMemoryRecordǁupdate_last_used__mutmut_2': xǁMemoryRecordǁupdate_last_used__mutmut_2
    }
    
    def update_last_used(self, *args, **kwargs):
        result = _mutmut_trampoline(object.__getattribute__(self, "xǁMemoryRecordǁupdate_last_used__mutmut_orig"), object.__getattribute__(self, "xǁMemoryRecordǁupdate_last_used__mutmut_mutants"), args, kwargs, self)
        return result 
    
    update_last_used.__signature__ = _mutmut_signature(xǁMemoryRecordǁupdate_last_used__mutmut_orig)
    xǁMemoryRecordǁupdate_last_used__mutmut_orig.__name__ = 'xǁMemoryRecordǁupdate_last_used'
