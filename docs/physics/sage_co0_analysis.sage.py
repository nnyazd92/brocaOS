...
# This file was *autogenerated* from the file sage_co0_analysis.sage
from sage.all_cmdline import *   # import sage library

_sage_const_80 = Integer(80); _sage_const_24 = Integer(24); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4); _sage_const_6 = Integer(6); _sage_const_8p315e18 = RealNumber('8.315e18'); _sage_const_16 = Integer(16); _sage_const_0p001929 = RealNumber('0.001929'); _sage_const_8 = Integer(8); _sage_const_6p67430en11 = RealNumber('6.67430e-11'); _sage_const_60 = Integer(60); _sage_const_12 = Integer(12)
...
try:
    ...
    possible_4D_irreps = [_sage_const_1 , _sage_const_2 , _sage_const_4 , _sage_const_6 ]  # Possible numbers
    co0_order = _sage_const_8p315e18 
    ...
    for k in possible_4D_irreps:
        ...
        fraction_estimate = (k * _sage_const_16 ) / co0_order  # 16 = 4^2
        print(f"  If {k} 4D irreps: f_sym ≈ {fraction_estimate:.3e}")
        
        # What η would be needed to match α_G?
        rho_leech = _sage_const_0p001929 
        dim_factor = _sage_const_4 /_sage_const_24 
        alpha_G_target = sqrt(_sage_const_8  * pi * _sage_const_6p67430en11 )
...
possible_subgroups = [
    ("A5", _sage_const_60 ),          # Icosahedral group
    ("S4", _sage_const_24 ),          # Symmetric group
    ("A4", _sage_const_12 ),          # Alternating group
    ("Dih4", _sage_const_8 ),         # Dihedral group
    ("Q8", _sage_const_8 ),           # Quaternion group
    ("Z4", _sage_const_4 ),           # Cyclic group
]
