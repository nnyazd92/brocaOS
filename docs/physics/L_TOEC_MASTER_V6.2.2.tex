...
\vspace{1cm}
\textbf{Version 6.2.2 - Curvature Fork Enforcement, Theorem Repatriation, Variational Poisson Derivation (Addressing Critical Feedback)}}
...
Dark Matter Ratio ($5+e^{-1}$) & P (Core) & \tagtheo & DMD-001 & Planck 2018 Audit \\
